...
class _ProfileSetupScreenState extends State<ProfileSetupScreen> {
  ...
  Future<void> _saveProfile() async {
    ...
    if (_age == null) missingFields.add('Yaş');
    if (_gender == null) missingFields.add('Cinsiyet');
    if (_education == null) missingFields.add('Eğitim');
    if (_bio.trim().isEmpty) missingFields.add('Bio');
    if (_lookingFor == null) missingFields.add('İlişki Tipi');

    if (missingFields.isNotEmpty) {
      showElegantWarning(
        context,
        'Lütfen tamamla: ${missingFields.join(", ")}',
      );
    ...
    try {
      ...
      if (mounted) {
        showElegantWarning(context, 'Bir hata oluştu: $e');
      }
    }
  }
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text(
                  _currentStep < _totalSteps - 1 ? 'DEVAM' : 'TAMAMLA',
