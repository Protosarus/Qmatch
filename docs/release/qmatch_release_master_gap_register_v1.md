...
| G-014 | scoring | TraitScoring→Canonical adapter planned_not_wired | **P2C-2A-7:** EQ live migration **BLOCKED** — legacy keyed EQ cannot map to 10D; TR pilot offline; EN pending. See `qmatch_eq_canonical_migration_audit_v1.md` | BLOCKED | blocker | 20D profile | EQ audit + pilot banks | P2C-2A-7R | Runtime-approved TR+EN EQ + EqTo20d | yes |
