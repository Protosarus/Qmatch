...
| G-014 | scoring | TraitScoring→Canonical adapter planned_not_wired | **P2C-2A-7R2:** live canonical EQ + EqTo20d **IMPLEMENTED** (14/20). Frequency still open. | IMPLEMENTED (Freq open) | blocker | 20D profile | eq runtime + EqTo20d | P2C-2A-8 | Frequency canonical group | yes |
