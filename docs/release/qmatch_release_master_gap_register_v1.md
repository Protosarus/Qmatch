...
| G-014 | scoring | TraitScoring→Canonical adapter planned_not_wired | **P2C-2A-7R1:** offline `eq_10d_uncalibrated_signed_evidence_v1` + TR/EN runtime candidates **COMPLETE**; live EQ + Eq→20D still pending. See `qmatch_eq_10d_scoring_math_v1.md` | BLOCKED_PENDING_RUNTIME_INTEGRATION | blocker | 20D profile | eq_bank_* + CanonicalEqScorer | P2C-2A-7R2 | Live EQ session + EqTo20d (no fake calibration) | yes |
