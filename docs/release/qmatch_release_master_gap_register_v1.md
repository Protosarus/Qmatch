...
| G-014 | scoring | TraitScoring→Canonical adapter planned_not_wired | **P2C-2A-7R2:** live EQ + EqTo20d **IMPLEMENTED** (14/20). **P2C-2A-8R1A:** Frequency 6D math/scorer + TR/EN 50-item banks **IMPLEMENTED_OFFLINE**. Live Frequency still legacy. | IMPLEMENTED_OFFLINE (Freq live open) | blocker | 20D profile | frequency_bank_*_v1 + frequency_scoring | P2C-2A-8R2 | Live Frequency + Frequency→20D | yes |
