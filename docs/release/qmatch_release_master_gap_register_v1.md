...
| G-014 | scoring | TraitScoring→Canonical adapter planned_not_wired | **P2C-2A-7R2:** live EQ + EqTo20d **IMPLEMENTED** (14/20). **P2C-2A-8R1:** Frequency 6D math/scorer **IMPLEMENTED_OFFLINE**; 50-item banks **BLOCKED** (separator+quality). Live Frequency still legacy. | IMPLEMENTED (Freq banks blocked) | blocker | 20D profile | eq runtime + EqTo20d; frequency_scoring | P2C-2A-8 | Frequency canonical group after bank coverage | yes |
