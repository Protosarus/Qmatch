#!/usr/bin/env python3
"""Apply Phase 3M-A3 Frequency content rewrite to frequency_set_021..030.
...
SCENARIOS_PATH = ROOT / "scripts" / "frequency_batch3_scenarios.json"
SET_RE = re.compile(r"^frequency_set_02[1-9]$|^frequency_set_030$")
...
def main() -> None:
    ...
    print(f"Rewrote Frequency batch 3: {n} questions in frequency_sets.json")
