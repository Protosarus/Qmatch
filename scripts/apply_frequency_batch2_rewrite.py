#!/usr/bin/env python3
"""Apply Phase 3M-A2 Frequency content rewrite to frequency_set_011..020.
...
SCENARIOS_PATH = ROOT / "scripts" / "frequency_batch2_scenarios.json"
SET_RE = re.compile(r"^frequency_set_01[1-9]$|^frequency_set_020$")
...
def main() -> None:
    ...
    print(f"Rewrote Frequency batch 2: {n} questions in frequency_sets.json")
