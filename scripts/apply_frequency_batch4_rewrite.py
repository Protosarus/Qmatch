#!/usr/bin/env python3
"""Apply Phase 3M-A4 Frequency content rewrite to frequency_set_031..040.
...
SCENARIOS_PATH = ROOT / "scripts" / "frequency_batch4_scenarios.json"
SET_RE = re.compile(r"^frequency_set_03[1-9]$|^frequency_set_040$")
...
def main() -> None:
    ...
    print(f"Rewrote Frequency batch 4: {n} questions in frequency_sets.json")
