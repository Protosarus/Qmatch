#!/usr/bin/env python3
"""Apply Phase 3M-A5 Frequency content rewrite to frequency_set_041..050.
...
SCENARIOS_PATH = ROOT / "scripts" / "frequency_batch5_scenarios.json"
SET_RE = re.compile(r"^frequency_set_04[1-9]$|^frequency_set_050$")
...
def main() -> None:
    ...
    print(f"Rewrote Frequency batch 5: {n} questions in frequency_sets.json")
